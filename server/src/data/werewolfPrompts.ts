...
export const WORDWOLF_PROMPTS: WordWolfPromptPair[] = [
  ...
  { category: '食べ物', villager: 'ホットドッグ', werewolf: 'フランクフルト', difficulty: 'hard' },
  { category: '食べ物', villager: 'ドーナツ', werewolf: 'ベーグル', difficulty: 'normal' },
  { category: '食べ物', villager: '焼き肉', werewolf: 'バーベキュー', difficulty: 'hard' },
  { category: '食べ物', villager: 'オムライス', werewolf: 'チャーハン', difficulty: 'normal' },
  { category: '食べ物', villager: '天ぷら', werewolf: 'フライ', difficulty: 'hard' },
  ...
  { category: '動物', villager: 'ヒツジ', werewolf: 'ヤギ', difficulty: 'hard' },
  { category: '動物', villager: 'カエル', werewolf: 'カメ', difficulty: 'easy' },
  { category: '動物', villager: 'クマ', werewolf: 'タヌキ', difficulty: 'normal' },
  { category: '動物', villager: 'ワニ', werewolf: 'トカゲ', difficulty: 'normal' },
  { category: '動物', villager: 'コウモリ', werewolf: 'フクロウ', difficulty: 'normal' },
  ...
  { category: '乗り物', villager: 'ロケット', werewolf: 'スペースシャトル', difficulty: 'hard' },
  { category: '乗り物', villager: '気球', werewolf: '飛行船', difficulty: 'normal' },
  { category: '乗り物', villager: 'スクーター', werewolf: 'セグウェイ', difficulty: 'normal' },
  ...
  { category: 'スポーツ', villager: 'ゴルフ', werewolf: 'ゲートボール', difficulty: 'hard' },
  { category: 'スポーツ', villager: 'アーチェリー', werewolf: 'ダーツ', difficulty: 'normal' },
  { category: 'スポーツ', villager: 'サーフィン', werewolf: 'ウィンドサーフィン', difficulty: 'hard' },
  ...
  { category: '場所', villager: '遊園地', werewolf: '動物園', difficulty: 'easy' },
  { category: '場所', villager: 'レストラン', werewolf: 'カフェ', difficulty: 'normal' },
  { category: '場所', villager: 'ホテル', werewolf: '旅館', difficulty: 'normal' },
  ...
  { category: '日用品', villager: '掃除機', werewolf: 'モップ', difficulty: 'normal' },
  { category: '日用品', villager: 'カバン', werewolf: 'リュック', difficulty: 'normal' },
  { category: '日用品', villager: 'ハサミ', werewolf: 'カッター', difficulty: 'normal' },
  { category: '日用品', villager: '歯ブラシ', werewolf: 'くし', difficulty: 'normal' },
  ...
  { category: '自然', villager: '雷', werewolf: '稲妻', difficulty: 'hard' },
  { category: '自然', villager: '川', werewolf: '滝', difficulty: 'normal' },
  { category: '自然', villager: '森', werewolf: '林', difficulty: 'hard' },
  { category: '自然', villager: '砂漠', werewolf: '草原', difficulty: 'normal' },
  ...
  { category: '人', villager: '魔女', werewolf: '魔法使い', difficulty: 'hard' },
  { category: '人', villager: '海賊', werewolf: '船長', difficulty: 'hard' },
  { category: '人', villager: 'ロボット', werewolf: '宇宙人', difficulty: 'easy' },
  { category: '人', villager: '赤ちゃん', werewolf: '子供', difficulty: 'hard' },
  ...
  { category: 'イベント', villager: '入学式', werewolf: '卒業式', difficulty: 'hard' },
  { category: 'イベント', villager: 'バレンタイン', werewolf: 'ホワイトデー', difficulty: 'hard' },
  { category: 'イベント', villager: '七夕', werewolf: 'ひな祭り', difficulty: 'normal' },
  ...
  { category: 'エンタメ', villager: 'ドラム', werewolf: '太鼓', difficulty: 'normal' },
  { category: 'エンタメ', villager: 'バイオリン', werewolf: 'チェロ', difficulty: 'hard' },
  { category: 'エンタメ', villager: 'トランプ', werewolf: 'UNO', difficulty: 'hard' },
];
...
export const IMPOSTOR_PROMPTS: ImpostorPrompt[] = [
  ...
  },
  {
    category: '食べ物',
    answer: 'ハンバーガー',
    decoys: ['ホットドッグ', 'サンドイッチ', 'タコス', 'ブリトー'],
    difficulty: 'easy',
  },
  {
    category: '食べ物',
    answer: 'アイスクリーム',
    decoys: ['かき氷', 'シェイク', 'パフェ', 'ゼリー'],
    difficulty: 'easy',
  },
  {
    category: '食べ物',
    answer: 'たこ焼き',
    decoys: ['お好み焼き', '焼きそば', 'もんじゃ焼き', '串カツ'],
    difficulty: 'normal',
  },
  ...
  },
  {
    category: '動物',
    answer: 'パンダ',
    decoys: ['コアラ', 'クマ', 'シロクマ', 'レッサーパンダ'],
    difficulty: 'easy',
  },
  {
    category: '動物',
    answer: 'カエル',
    decoys: ['カメ', 'トカゲ', 'ヤモリ', 'イモリ'],
    difficulty: 'normal',
  },
  ...
  },
  {
    category: '乗り物',
    answer: '自転車',
    decoys: ['バイク', 'スクーター', '三輪車', '一輪車'],
    difficulty: 'easy',
  },
  {
    category: '乗り物',
    answer: 'パトカー',
    decoys: ['消防車', '救急車', 'タクシー', 'バス'],
    difficulty: 'easy',
  },
  ...
  },
  {
    category: 'スポーツ',
    answer: 'ボクシング',
    decoys: ['柔道', '空手', 'レスリング', 'テコンドー'],
    difficulty: 'normal',
  },
  {
    category: 'スポーツ',
    answer: 'スキー',
    decoys: ['スノーボード', 'アイススケート', 'カーリング', 'ボブスレー'],
    difficulty: 'easy',
  },
  ...
  },
  {
    category: '場所',
    answer: '富士山',
    decoys: ['エベレスト', 'アルプス', '桜島', '阿蘇山'],
    difficulty: 'normal',
  },
  {
    category: '場所',
    answer: '東京タワー',
    decoys: ['スカイツリー', 'エッフェル塔', '自由の女神', 'ビッグベン'],
    difficulty: 'normal',
  },
  ...
  },
  {
    category: 'イベント',
    answer: '結婚式',
    decoys: ['成人式', '葬式', '入学式', '卒業式'],
    difficulty: 'normal',
  },
  {
    category: 'イベント',
    answer: '誕生日パーティー',
    decoys: ['ホームパーティー', 'バーベキュー', 'ピクニック', 'キャンプ'],
    difficulty: 'easy',
  },
];
