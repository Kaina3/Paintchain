...
const ANIME_CHARACTERS: QuizPromptItem[] = [
  ...
  // 僕のヒーローアカデミア
  { word: '緑谷出久', hint: '僕のヒーローアカデミア' },
  { word: '爆轟勝己', hint: '僕のヒーローアカデミア' },
  ...
  { word: 'ジーニー', hint: 'ディズニー (アラジン)' },
  { word: 'ジュディ', hint: 'ディズニー (ズートピア)' },
  { word: 'ニック', hint: 'ディズニー (ズートピア)' },
  { word: 'ダンボ', hint: 'ディズニー' },
  ...
  { word: 'アイアンマン', hint: 'ディズニー（マーベル）' },
  { word: 'キャプテン・アメリカ', hint: 'ディズニー（マーベル）' },
  { word: 'ソー', hint: 'ディズニー（マーベル）' },
  { word: 'ハルク', hint: 'ディズニー（マーベル）' },
  { word: 'スパイダーマン', hint: 'ディズニー（マーベル）' },

  // ユニバーサルスタジオ
  { word: 'ミニオン', hint: 'ユニバーサルスタジオ' },
  { word: 'スヌーピー', hint: 'Peanuts' },
  { word: 'キングコング', hint: 'ユニバーサルスタジオ' },
  { word: 'ハリー・ポッター', hint: 'ユニバーサルスタジオ' },
  { word: 'バックトゥザフューチャー', hint: 'ユニバーサルスタジオ' },
  'スポンジボブ'
];

// 物語
const STORIES: QuizPromptItem[] = [
  'ももたろう', 
  'きんたろう',
  'かぐやひめ', 
  'いっすんぼうし', 
...
// 偉人・有名人
const FAMOUS_PEOPLE: QuizPromptItem[] = [
  'レオナルド・ダ・ヴィンチ',
  'アインシュタイン',
  'クレオパトラ',
  'ガリレオ・ガリレイ',
